...
function Demo (opts) { // see also https://www.youtube.com/watch?v=y4TELgx28D4 {{{1
  ...
  then(_ => fcrs(opts)). // Offer freshly caught red snapper.
...
function issuerClaimant (effect, opts) { // {{{1
  opts.log('issuerClaimant effect', effect)

}

function issuerClaimant4User (effect, opts) { // {{{1
  opts.log('issuerClaimant4User effect', effect)
