...
function handle_stateInitial (e) { // {{{1
  //this.log('handle_stateInitial this.context.state', this.context.state)

  stateInitial.resolve()
  this.context.state = stateAnnBobSettingUp
}

function handle_stateAnnBobSetUp (e) { // {{{1
  this.log('handle_stateAnnBobSetUp this', this)

  return Promise.resolve();
}

function handle_stateAnnBobSettingUp (e) { // {{{1
  //this.log('handle_stateAnnBobSettingUp this.context.state', this.context.state)
